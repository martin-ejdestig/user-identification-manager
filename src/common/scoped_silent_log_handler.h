...
#ifndef USER_IDENTIFICATION_MANAGER_COMMON_SCOPED_SILENT_LOG_HANDLER_H
#define USER_IDENTIFICATION_MANAGER_COMMON_SCOPED_SILENT_LOG_HANDLER_H
...
#endif // USER_IDENTIFICATION_MANAGER_COMMON_SCOPED_SILENT_LOG_HANDLER_H
